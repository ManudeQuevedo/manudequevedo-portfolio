...
export const skills = {
  frontend: [
    ...
    { name: "GSAP", level: "familiar", context: "Targeted timeline-based motion" },
    { name: "JavaScript ES6+", level: "expert", context: "Foundation of everything I build" },
    { name: "Figma", level: "proficient", context: "UI design & prototyping" },
    { name: "A11y", level: "proficient", context: "WCAG-first implementation" },
    { name: "Performance Optimization", level: "proficient", context: "Core Web Vitals and Lighthouse tuning" },
  ],
  cloud: [
  ...
  security: [
    ...
    { name: "CSRF", level: "proficient", context: "Session and form-flow hardening" },
    { name: "Penetration Testing Basics", level: "familiar", context: "Baseline offensive testing literacy" },
  ],
  ai: [
  ...
  tools: [
    ...
    { name: "PostgreSQL", level: "familiar", context: "Schema design and querying fundamentals" },
    { name: "MongoDB", level: "familiar", context: "Document modeling and CRUD workflows" },
  ],
};
